...
exports['default'] = function () {
  ...
  return {
    ...
    TimePicker: _extends({}, defaultTheme.TimePicker, customTheme.TimePicker),

    TimeHeader: _extends({}, defaultTheme.TimeHeader, customTheme.TimeHeader),

    Time: _extends({}, defaultTheme.Time, customTheme.Time),

    TimePassive: _extends({}, defaultTheme.TimePassive, customTheme.TimePassive),

    TimeHover: _extends({}, defaultTheme.TimeHover, customTheme.TimeHover),

    TimeActive: _extends({}, defaultTheme.TimeActive, customTheme.TimeActive),

    TimeSelected: _extends({}, defaultTheme.TimeSelected, customTheme.TimeSelected),

    TimeInRange: _extends({}, defaultTheme.TimeInRange, customTheme.TimeInRange),

    TimeRange: _extends({}, defaultTheme.TimeRange, customTheme.TimeRange)
  };
};
