  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays() {
      ...
      for (var i = diff; i >= 1; i--) {
        ...
        days.push({ dayMoment: dayMoment, isPassive: this.props.allowPassive });
      }
...
Calendar.propTypes = {
  sets: _react2['default'].PropTypes.string,
  range: _react2['default'].PropTypes.shape({
    startDate: _react2['default'].PropTypes.object,
    endDate: _react2['default'].PropTypes.object
  }),
  date: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.object, _react2['default'].PropTypes.string, _react2['default'].PropTypes.func]),
  format: _react2['default'].PropTypes.string.isRequired,
  firstDayOfWeek: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.number, _react2['default'].PropTypes.string]),
  onChange: _react2['default'].PropTypes.func,
  onInit: _react2['default'].PropTypes.func,
  link: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.shape({
    startDate: _react2['default'].PropTypes.object,
    endDate: _react2['default'].PropTypes.object
  }), _react2['default'].PropTypes.bool]),
  linkCB: _react2['default'].PropTypes.func,
  theme: _react2['default'].PropTypes.object,
  allowPassive: _react2['default'].PropTypes.bool
};
